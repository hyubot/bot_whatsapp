...
*/
const A187 = '👾WahyuBots��'; // JANGAN UBAH-UBAH INFO!!!
...
conn.sendMessage(id, ' *Owner WAHYUBOTS wa.me/+6282323755174* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Creator WAHYUBOTS wa.me/+6282323755174* ' ,MessageType.text);
}
else if (text == 'Pagi'){
