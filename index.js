...
const aktif = 'Tergantung Jaringan'; // DI GANTI AUTO EROR
...
conn.sendMessage(id, '3aalaikumsalam, Ketik *.help* Untuk Menampilkan Menu' ,MessageType.text);
}
else if (text == 'salam'){
...
conn.sendMessage(id, 'utamakan sallam, *Assallamuallaikum* .' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'utamakan sallam, *Assallamuallaikum* .' ,MessageType.text);
}
...
conn.sendMessage(id, 'Hai Kak?, Ketk *.help* Untuk Menampilkan Menu' ,MessageType.text);
}
else if (text == '.ttp'){
...
conn.sendMessage(id, 'Kntl Mu Kecil' ,MessageType.text);
}
else if (text == 'beb'){
conn.sendMessage(id, 'Iyaa beb?. Ketik *.help* Untuk Menampilkan Menu' ,MessageType.text);
}
else if (text == 'Annyeong'){
conn.sendMessage(id, 'Nee Annyeong Kak? Ketik *.help* Untuk Menampilkan Menu' ,MessageType.text);
}
else if (text == 'annyeong'){
conn.sendMessage(id, 'Nee Annyeong Kak? Ketik *.help* Untuk Menampilkan Menu' ,MessageType.text);
}
...
//Tolonglah bro jangan di ubah ubah L4LISA
