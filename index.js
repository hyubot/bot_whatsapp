...
const groupwa = 'Valid'; // OFFICIAL GRUP LU 1
const youtube = 'Valid'; // OFFICIAL GRUP LU 2
//
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *LALISA BOTS* , Follow IG Owner Yah❣️ : https://instagram.com/psicyo.lv' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *LALISA BOTS* , Follow IG Owner Yah❣️ : https://instagram.com/psicyo.lv' ,MessageType.text);
}
