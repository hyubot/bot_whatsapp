...
*/
const XPTN = 'L4LISA-BOT'; // JANGAN DI UBAH NNTI EROR
const instagram = 'https://instagram.com/psicyo.lv'; // JANGAN DI UBAH NNTI EROR
const nomer = 'https://Wa.me/+6282323755174'; // JANGAN DI UBAH NANTI EROR
const aktif = 'Tegantung Jaringan'; // DI GANTI AUTO EROR
const groupwa = 'https://chat.whatsapp.com/'; // DI GANTI AUTO EROR
...
conn.sendMessage(id, '3aalaikumsalam, Ketik *.help* Untuk Menampilkan Menu Bot Ini' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, Ketik *.help* Untuk Menampilkan Menu Bot Ini' ,MessageType.text);
}
...
else if (text == 'Samlekom'){
conn.sendMessage(id, 'Salam Yang Bener Goblok, Ketik *.help* Untuk Menampilkan Menu Bot Ini' ,MessageType.text);
}
else if (text == 'p'){
...
conn.sendMessage(id, 'Halo Kk?, Ketik *.help* Untuk Menampilkan Menu.' ,MessageType.text);
}
else if (text == 'Asu'){
conn.sendMessage(id, 'Lu Asw' ,MessageType.text);
}
else if (text == '.owner'){
conn.sendMessage(id, 'Owner L4LISA-BOT : wa.me/+6282323755174' ,MessageType.text);
}
else if (text == 'Lisa'){
conn.sendMessage(id, 'Iyaa Knapa Kak' ,MessageType.text);
}
else if (text == 'lisa'){
conn.sendMessage(id, 'Pacarnya Mas Wahyu' ,MessageType.text);
}
...
conn.sendMessage(id, 'Test 1,2,3 ketik *.help* Untuk Menampilkan Menu' ,MessageType.text);
}
else if (text == 'Hai'){
conn.sendMessage(id, 'Hai kk?, Ketik *.help* Untuk Menampilkan Menu.' ,MessageType.text);
}
else if (text == '.ttp'){
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/6282323755174* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Apaan Woi.?, Ketik *.help* Untuk Menampilkan Menu.' ,MessageType.text);
}
else if (text == 'Eoy'){
conn.sendMessage(id, 'Ya?, Ketik *.help* Untuk Menampilkan Menu.' ,MessageType.text);
}
else if (text == 'Hi'){
conn.sendMessage(id, 'Hi?, Ketik *.help* Untuk Menampilkan Menu' ,MessageType.text);
}
else if (text == 'Gan'){
conn.sendMessage(id, 'Iyaa Knapa Gan?, Ketik *.help* Untuk Menampilkan Menu.' ,MessageType.text);
}
else if (text == 'Sis'){
conn.sendMessage(id, 'Ya?, Ketik *.help* Untuk Menampilkan Menu.' ,MessageType.text);
}
...
else if (text == 'Annyeong'){
conn.sendMessage(id, 'Nee Annyeong Kk ?, Ketik *.help* Untuk Menampilkan Menu'.MessageType.text);
}
else if (text == 'annyeong'){
conn.sendMessage(id, 'Nee Annyeong Kk ?, Ketik *.help* Untuk Menampilkan Menu' ,MessageType.text);
}
...
conn.sendMessage(id, ' *Menampilkan Pengguna Bot* ' ,MessageType.text);
}
else if (text == '.tools2'){
conn.sendMessage(id, ' *Menampilkan Pengguna Bot* ' ,MessageType.text);
}
...
conn.sendMessage(id, 'Astagfirulllah' ,MessageType.text);
}
else if (text == 'makasi'){
...
if (text.includes(".sholat")){
  ...
  axios.get(`https://api.haipbis.xyz/jadwalsholat?daerah=${query}`).then ((res) =>{
  conn.sendMessage(id, '[WAIT] Searching...❗', MessageType.text)
...
conn.sendMessage(id, ' _Follow Instagram Owner : https://instagram.com/psicyo.lv_' ,MessageType.text);
}
else if (text == '.tool2'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *L4LISA-BOT* , Follow Instagram Owner Yah😻 : https://instagram.com/pcicyo.lv' ,MessageType.text);
}
else if (text == '.tools3'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *L4LISA-BOT* , Follow Instagram Owner Yah😻 : https://instagram.com/psicyo.lv' ,MessageType.text);
}
