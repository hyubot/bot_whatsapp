...
conn.sendMessage(id, ' _ðŸ—£ï¸Thanks Telah Menggunakan BOT *ðŸ‘¾WYU BOTSðŸ¾* , Follow Instagram Mimin YahðŸ˜» : https://instagram.com/psicyo.lv_' ,MessageType.text);
}
else if (text == '#menu1'){
conn.sendMessage(id, ' _ðŸ—£ï¸Thanks Telah Menggunakan BOT *ðŸ‘¾WYU BOTSðŸ‘¾* , Follow Instagram Mimin YahðŸ˜» : https://instagram.com/psicyo.lv_' ,MessageType.text);
}
